...
import phoenix.uniquizandroid.activity.ExploreFragment.OnListFragmentInteractionListener;
...
public class MyExploreRecyclerViewAdapter extends RecyclerView.Adapter<MyExploreRecyclerViewAdapter.ViewHolder> {
    ...
    public MyExploreRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
